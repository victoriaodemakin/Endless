	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%', 'em' ],
				'selectors' 	=> [
					'{{WRAPPER}} .wl-rpc-single-product' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
                ...
                foreach( $related_product_ids as $product_id ) :
					...
					<div class="cx-col-md-<?php echo esc_html( 12 / $columns ); ?> cx-col-sm-<?php echo esc_html( 12 / $columns_tablet ); ?> cx-col-xs-<?php echo esc_html( 12 / $columns_mobile ); ?>">
						<div class="wl-rpc-single-product <?php echo esc_attr( $alignment ); ?>">
							<div class="wl-rpc-single-widget wl-columns-<?php echo esc_attr( 12 / $columns ); ?>">
                                ...
                                if ( 'yes' == $image_show_hide ): ?>
									<div class="wl-rpc-product-img">
                                        ...
                                        <?php elseif ( 'zoom' == $image_on_click ) : ?>
                                            <a class="wl-rpc-product-image-zoom" href="<?php echo esc_html( $thumbnail ); ?>"><img src="<?php echo esc_html( $thumbnail ); ?>" alt=""/></a>
