			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'4'             => __('Style Four', MELA_TD),
						'5'             => __('Style Five', MELA_TD),
						'clf-pro-1'     => __('Style Five (Pro)', MELA_TD),
						'clf-pro-2'     => __('Style Six (Pro)', MELA_TD),
						'clf-pro-3'     => __('Style Seven (Pro)', MELA_TD),
						'clf-pro-4'     => __('Style Eight (Pro)', MELA_TD),
						'clf-pro-5'     => __('Style Nine (Pro)', MELA_TD),
						'clf-pro-6'     => __('Style Ten (Pro)', MELA_TD),
						'clf-pro-7'     => __('Style Eleven (Pro)', MELA_TD),
					],
					'description' => sprintf(
