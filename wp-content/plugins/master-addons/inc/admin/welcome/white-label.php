                ...
                <div class="jltma-white-label-notice">
                    <div class="jltma-white-label-notice-content">
                        <div class="jltma-white-label-notice-logo">
                            <img src="<?php 
echo  esc_url( MELA_IMAGE_DIR ) . 'logo.png' ;
?>" alt="Master Addons">
                        </div>
                        <h2><?php 
_e( 'Upgrade <span>Pro</span> for White Labeling', MELA_TD );
?></h2>
                        <p>
                            <?php 
_e( 'Master Addons can be completely re-branded with your own brand Logo, Name and Author Details. Your clients will never know what tools you are using to build their website and will think that this is your own tool set. White-labeling works as long as your license is active.', MELA_TD );
?><br>
                            <em><?php 
_e( 'Note: Developer Plans Only', MELA_TD );
?></em>
                        </p>
                        <a class="jltma-btn master-addons-widget-btn jltma-get-pro" href="<?php 
...
?>
            ...
            <div class="api-settings-element">
                <h3><?php 
echo  esc_html__( 'White Label Settings', MELA_TD ) ;
?></h3>
                    ...
                    <div class="api-forms">
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_logo">
                                <?php 
echo  esc_html__( 'Logo Image', MELA_TD ) ;
?>
                            </label>
...
?>
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_name">
                                <?php 
echo  esc_html__( 'Plugin Name', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_name" type="text" class="form-control jltma_wl_plugin_name" value="<?php 
...
?>">
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_desc">
                                <?php 
echo  esc_html__( 'Plugin Description', MELA_TD ) ;
?>
                            </label>
                            <textarea name="jltma_wl_plugin_desc" type="text" class="form-control jltma_wl_plugin_desc" cols="50"><?php 
...
?></textarea>
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_author_name">
                                <?php 
echo  esc_html__( 'Developer/Agency Name', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_author_name" type="text" class="form-control jltma_wl_plugin_author_name" value="<?php 
...
?>">
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_menu_label">
                                <?php 
echo  esc_html__( 'Menu Label', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_menu_label" type="text" class="form-control jltma_wl_plugin_menu_label" value="<?php 
...
?>">
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_url">
                                <?php 
echo  esc_html__( 'Plugin URL', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_url" type="text" class="form-control jltma_wl_plugin_url" value="<?php 
...
?>">
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_row_links">
                                <?php 
echo  esc_html__( 'Hide Plugin Row Meta Links', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_row_links" type="checkbox" class="form-control jltma_wl_plugin_row_links" <?php 
checked( 1, $jltma_white_label_options['jltma_wl_plugin_row_links'], true );
?>>
                            <p class="pl-3"><?php 
echo  __( 'This will hide Support, Docs & FAQs and Video Tutorials links on Plugins page.', MELA_TD ) ;
?></p>
                        </div>
            ...
            <div class="api-settings-element">
                <h3><?php 
echo  esc_html__( 'Admin Settings', MELA_TD ) ;
?></h3>
                <div class="api-element-inner">
                    <div class="api-forms">
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_tab_welcome">
                                <?php 
echo  esc_html__( 'Hide Welcome Tab', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_tab_welcome" type="checkbox" class="form-control jltma_wl_plugin_tab_welcome" <?php 
...
?>>
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_tab_addons">
                                <?php 
echo  esc_html__( 'Hide Addons Tab', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_tab_addons" type="checkbox" class="form-control jltma_wl_plugin_tab_addons" <?php 
...
?>>
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_tab_extensions">
                                <?php 
echo  esc_html__( 'Hide Extensions Tab', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_tab_extensions" type="checkbox" class="form-control jltma_wl_plugin_tab_extensions" <?php 
...
?>
                            ...
                            <input name="jltma_wl_plugin_tab_api" type="checkbox" class="form-control jltma_wl_plugin_tab_api" <?php 
...
?>>
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_tab_white_label">
                                <?php 
echo  esc_html__( 'Hide White Label Tab', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_tab_white_label" type="checkbox" class="form-control jltma_wl_plugin_tab_white_label" <?php 
...
?>>
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_tab_version">
                                <?php 
echo  esc_html__( 'Hide Version Tab', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_tab_version" type="checkbox" class="form-control jltma_wl_plugin_tab_version" <?php 
...
?>>
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_tab_changelogs">
                                <?php 
echo  esc_html__( 'Hide Changelogs Tab', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_tab_changelogs" type="checkbox" class="form-control jltma_wl_plugin_tab_changelogs" <?php 
...
?>>
                        ...
                        <div class="form-group">
                            <label for="jltma_wl_plugin_tab_system_info">
                                <?php 
echo  esc_html__( 'Hide System Info Tab', MELA_TD ) ;
?>
                            </label>
                            <input name="jltma_wl_plugin_tab_system_info" type="checkbox" class="form-control jltma_wl_plugin_tab_system_info" <?php 
...
?></strong>
                            <?php 
echo  __( 'You will need to reactivate Master Addons PRO for Elementor plugin to be able to reset White Labeling Tab Options.', MELA_TD ) ;
?>
                        </p>
