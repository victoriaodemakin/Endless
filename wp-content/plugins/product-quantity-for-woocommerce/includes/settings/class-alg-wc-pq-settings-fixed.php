	...
	function get_settings() {
		$fields = array(
			array(
				...
				'type'     => 'title',
				'desc'	   => __('Specify fixed (allowed/disallowed) quantities for products in your store, settings here overwrite minimum/maximum/or step quantities (if defined site-wide), only the values here will be accepted for the products that have this field defined.
