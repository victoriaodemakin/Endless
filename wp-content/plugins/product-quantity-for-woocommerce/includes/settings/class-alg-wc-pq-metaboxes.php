						...
						default:
							if($option['desc'] != 'Main variable product') {
								...
								if (strpos($option['name'], 'alg_wc_pq_min_') !== false) {
									...
									$option_value = get_post_meta( $the_post_id, $alg_wc_pq_min_name, true );
									if($option_value == 'yes') {
										$checked = 'checked';
									}
									$maybe_tooltip = ( isset( $option['tooltip'] ) && '' != $option['tooltip'] ) ? wc_help_tip( "Add To All Min Variation", true ) : '';
									$field_html .= ' <input class="add_to_all_main" id="'.$option['name'].'_to_all" name="'.$option['name'].'_to_all" type="checkbox" '.$checked.' value="'.$option_value.'" /><b>Add To All</b>'.$maybe_tooltip;
									...
									$field_html .= ' <input class="add_to_all_main" id="'.$option['name'].'_to_all" name="'.$option['name'].'_to_all" type="checkbox" '.$checked1.' value="'.$option_value.'" /><b>Add To All</b>'.$maybe_tooltip;
									...
									$field_html .= ' <input class="add_to_all_main" id="'.$option['name'].'_to_all" name="'.$option['name'].'_to_all" type="checkbox" '.$checked2.' value="'.$option_value.'" /><b>Add To All</b>'.$maybe_tooltip;
								} else if(strpos($option['name'], 'alg_wc_pq_default_') !== false) {
									$alg_wc_pq_default_name = 'alg_wc_pq_default_'.$the_post_id.'_to_all';
									$option_value2 = get_post_meta( $the_post_id, $alg_wc_pq_default_name, true );
									if($option_value2 == 'yes') {
										$checked2 = 'checked';
									}
