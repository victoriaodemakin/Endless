	...
	function get_settings() {
		...
		$general_settings = array(
			...
			array(
				...
				'desc_tip' => __( 'Use decimal values on minimum/maximum/step quantities, so to allow orders to buy in decimal, a decimal value needs to be used in min/max/step (i.e. to sell in 0.5 quantity, it has to be defined on step for example)', 'product-quantity-for-woocommerce' ),
