...
function myticket_add_cart_item_custom_data( $cart_item_meta, $product_id ) {
    ...
    // pays numer of days for cart calendar
...
function myticket_before_cart_contents() {
    ...
    <?php if ( '1' == get_theme_mod('myticket_participants', '0') ){ ?>

        <script>
        var allowCheckout = false, nameValidated = true, emailValidated = true, calValidated = true, nameUpdated = true, emailUpdated = true, calUpdated = true;
    ...
    <?php } ?>
        ...
        function revalidate(){
            ...
            jQuery('.cart_cal').each(function(index){if(jQuery('.cart_cal').val() === ""){calValidated = false; allowCheckout = false; }});
        }

        function checkIfUpdated(){

            nameUpdated = emailUpdated = calUpdated = true;
            ...
            jQuery('.cart_cal').each(function(index){if(jQuery('.cart_cal').data('value') === ""){calUpdated = false;}});
        }
